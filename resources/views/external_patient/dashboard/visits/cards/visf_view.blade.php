...
<div id="VISF" class="col-md-6 mt-3">
            	<div class="card card-outline ">
					   ...
					   <div class="card-header">
							<div class="card-title"><u><b>{{__('Visual field document')}}</b></u></div>
			               ...
			               <div class="row m-1" style="overflow-x:hidden;">
							      @if(isset($visf_doc))
											<div class="col-md-4 col-6  border">
													<a class="spotlight" data-title="{{$visf_doc->real_name }}" 
													 href="{{ UserHelper::rp_txt($visf_doc->path) }}" 
													 data-download="true"
													 data-button="{{__('Print')}}" data-button-href="javascript:window.print()">
														<img  class="img-fluid" alt="" src="{{ UserHelper::rp_txt($visf_doc->thumb_path) }}" style="width:100%;height:100%;"/>
													</a>
												
												
											</div>
											
										@if(isset($visf_doc->notes) && $visf_doc->notes !='') 
											<div class="table-responsive col-md-12 border">
											   <table class="table-borderless" style="width:100%;">
											   <tr><th style="text-align:center;">{{__("Description")}}</th></tr>
											   <tr><td>{!!nl2br($visf_doc->notes)!!}</td></tr>
											  </table>
											 </div>
