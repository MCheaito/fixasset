...
-->
<div id="OCT" class="col-md-6 mt-3">
            	<div class="card card-outline ">
				    		   
					   <div class="card-header">
							<div class="card-title"><u><b>{{__('Medical oct images')}}</b></u></div>
							<div class="card-tools">
							   <button type="button" class="btn btn-sm btn-resize border border-radius rounded-circle" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
						...
						<div class="card-body" style="overflow-x:hidden;">
			                 <div class="row">
								   ...
								   @if(count($OCT_images)>0)
									  @foreach($OCT_images as $image)
								        @php $ext = explode(".",$image->image_name)[1]; @endphp
										<div class="text-center spotlight-group col-md-2 col-4 m-1 border">
