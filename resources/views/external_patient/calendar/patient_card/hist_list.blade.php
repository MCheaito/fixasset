<div class="container-fluid">	
			<div class="row  m-1" style="overflow-x:auto;height:350px;overflow-y: auto;">
			  <div class="col-md-12">
			        <table id="hist_table" class="table table-bordered table-striped  data-table nowrap" style="width:100%;">
									<thead>
										<tr>
											<th>{{__('Action')}}</th>
											<th>{{__('#')}}</th>
									...
									<tbody>
									  ...
									  @foreach($history as $h)
									   <tr>
									     <td><a onclick="PopupCenter('{{route('emr.visit.history.index',[app()->getLocale(),$h->id])}} ', '{{__('History form')}}','1000','500')" class="btn btn-action btn-sm">{{__('View')}}<span class="ml-1"><i class="fa fa-eye"></i></span></a></td>
										 <td>{{$h->id}}</td>
