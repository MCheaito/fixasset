			  ...
			  <div class="col-md-12">
			        <table id="dash_bills_table" class="table table-bordered table-striped  data-table nowrap" style="width:100%;">
									...
									<tbody>
									  ...
									  @foreach($bills as $b)
									   <tr>
									     <td><a onclick="PopupCenter('{{ route('emr.billing.edit',[app()->getLocale(),$b->id]) }} ', '{{__('Bills')}}','1000','500')"  class="btn btn-action btn-sm">{{__('View')}}<span class="ml-1"><i class="fa fa-eye"></i></span></a></td>
										 <td>{{$b->id}}</td>
