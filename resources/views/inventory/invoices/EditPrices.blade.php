        ...
        <section class="col-md-12">	
			<div class="card">	  
				<div class="card-header">
				  <div class="row">
					  <div class="col-md-9 col-7"><h5>{{__('Edit Prices')}}</h5></div>
				...
				<div class="card-body p-0">
				    <div  class="row m-1"> 
					   ...
					   <div class="col-md-6">
						 ...
						 <button class="m-1 float-right btn btn-action"  id="btnaccount" name="btnaccount" onclick="event.preventDefault();TransAcount({{$ReqPatient->id}})" hidden >{{__('Account')}}</button>
					   </div>
					...
					<div  class="row m-1"> 
						...
						<div  class="row m-1"> 
										...
										<div class="form-group col-md-3 select2-primary" hidden >
					...
					<div class="row m-1">
						...
						<div class="col-md-2 col-6" hidden>
											...
											<div class="col-md-2 col-6">
														<label for="name">{{__('Box Price')}}&#xA0;&#xA0;</label>
															<div class="form-group">
								...
								<table id="myTable" class="table table-striped table-bordered table-hover" style="text-align:center;">
								   ...
								   <tbody>
									...
									@foreach ($ReqDeails as $sReqDeails) 
													...
													<td>{{$sReqDeails->ref_invoice}}</td>
													<td>{{$sReqDeails->item_name}}</td>
													<td><input type="text" class="form-control" size="3"  id="unitprice{{$cpt}}" value="{{$sReqDeails->initprice}}"  onchange="RetRow1(this,'valqty{{$cpt}}')"  oninput="RetRow1(this,'valqty{{$cpt}}')" disabled /></td>											
													<td><input type="text" class="form-control" size="3"  id="kitprice{{$cpt}}" value="{{$sReqDeails->price}}"  onchange="RetRow1(this,'valqty{{$cpt}}')"  oninput="RetRow1(this,'valqty{{$cpt}}')" disabled /></td>											
													<td><input type="text" class="form-control" size="3"  id="boxprice{{$cpt}}" value="{{$sReqDeails->sel_price}}"  onchange="RetRow1(this,'valqty{{$cpt}}')"  oninput="RetRow1(this,'valqty{{$cpt}}')" disabled /></td>											
    ...
    success: function(data){
		...
		if(data.success){	
          ...
          //disable button delete in table 
			...
			var j=1;
			for(i=1;i<=nb;i++){
			var unitprice="unitprice"+j;	
			var kitprice="kitprice"+j;	
			var boxprice="boxprice"+j;	
			...
			document.getElementById(unitprice).setAttribute('disabled',false);
			document.getElementById(kitprice).setAttribute('disabled',false);
			document.getElementById(boxprice).setAttribute('disabled',false);
...
function modifyinventory()
{
		...
		//	alert(rdel);
			...
			document.getElementById(kitprice).disabled = false;
			document.getElementById(boxprice).disabled = false;
