		    ...
		    <div class="card">
				<div class="card-body">
						...
						<div class="row m-1" style="text-align:center;background-color:#e9ecef;overflow:auto;">
							...
							<div class="mb-1 col-md-2 col-4">
							   <label for="name" hidden>{{__('T.Payment')}}</label>
							   <input  class="text-center form-control"  id="tpay" value="{{$pay}}" disabled  hidden />
							</div>
							<div class="mb-1 col-md-2 col-4">
...
arr[i]={"CODE":document.getElementById("myTable").rows[i].cells[0].innerHTML,"DESCRIP":document.getElementById("myTable").rows[i].cells[1].innerHTML,"QTY":document.getElementById("myTable").rows[i].cells[2].innerHTML,"PRICE":document.getElementById("myTable").rows[i].cells[3].innerHTML,"TOTAL":document.getElementById("myTable").rows[i].cells[4].innerHTML,"RQTY":rqty,"RPRICE":rprice};	
