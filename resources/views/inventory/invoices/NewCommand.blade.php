        ...
        <section class="col-md-12">	
			<div class="card">	  
				...
				<div class="card-header">
				  <div class="row">
					  <div class="col-md-9 col-7"><h5>{{__('New Command')}} - {{__($type1->name)}}</h5></div>
				...
				<div class="card-body p-0">
					...
					<div  class="row m-1">  
					   ...
					   <div class="col-md-6"> <label for="invoice_rq"><b>{{__('Remark')}}</b></label> 
...
e.innerHTML=total;
f.innerHTML="0";
g.innerHTML=document.getElementById("valprice").value;
...
arr[i]={"CODE":document.getElementById("myTable").rows[i].cells[0].innerHTML,"DESCRIP":document.getElementById("myTable").rows[i].cells[1].innerHTML,"QTY":document.getElementById("myTable").rows[i].cells[2].innerHTML,"PRICE":document.getElementById("myTable").rows[i].cells[3].innerHTML,"TOTAL":document.getElementById("myTable").rows[i].cells[4].innerHTML,"RQTY":document.getElementById("myTable").rows[i].cells[5].innerHTML,"RPRICE":document.getElementById("myTable").rows[i].cells[6].innerHTML};	
