      ...
      <div class="card-header report-menu">
		 ...
		 <div class="row m-1">
			...
			<div class="col-md-3">
			   ...
			   <select class="select2_patient custom-select rounded-0" name="filter_patient" id="filter_patient" style="width:100%;">
			 ...
			 <div class="col-md-3">
			   <label class="label-size">{{__('Item Supplier')}}</label>
...
$(document).ready(function(){
    ...
    ajaxURL:"{{route('inventory.reports.inventory_sales_per_supplier',app()->getLocale())}}", //ajax URL
    ajaxParams: function(){
		...
		return {filter_supplier:filter_supplier, filter_item:filter_item,filter_patient:filter_patient,
    ...
    columns:[
		...
		{title:"{{__('Patient')}}", field:"patName"},
...
$('#generate').click(function(e){
	...
	table.setData("{{route('inventory.reports.inventory_sales_per_supplier',app()->getLocale())}}", 
	              {filter_supplier:filter_supplier, filter_item:filter_item,filter_patient:filter_patient,
		           filter_fromdate:filter_fromdate,filter_todate:filter_todate,filter_inv_type:filter_inv_type});
