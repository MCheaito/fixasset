...
$(document).ready(function(){
    ...
    ajaxURL:"{{route('inventory.reports.inventory_purchases_per_pay',app()->getLocale())}}", //ajax URL
    ajaxParams: function(){
		...
		return {filter_payment_type:filter_payment_type,filter_supplier:filter_supplier,
    ...
    columns:[
		...
		{title:"{{__('Date')}}", field:"payment_date"},
		...
		{title:"{{__('Supplier')}}", field:"suppName",formatter:function(cell, formatterParams, onRendered){
				var data = cell.getValue();
				if(data !=null && data!='') { 
				return data; 
				}else{ 
    ...
    $('#generate').click(function(e){
		...
		var filter_due_amount=$('#filter_due_amount').val();
		var filter_inv_type = $('#filter_inv_type').val();
		table.setData("{{route('inventory.reports.inventory_purchases_per_pay',app()->getLocale())}}", 
					  {filter_payment_type:filter_payment_type,filter_supplier:filter_supplier,
					   filter_fromdate:filter_fromdate,filter_todate:filter_todate,filter_due_amount:filter_due_amount,
					   filter_inv_type:filter_inv_type});
