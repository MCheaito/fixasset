...
$(document).ready(function(){
    ...
    ajaxURL:"{{route('inventory.reports.inventory_sales_per_item',app()->getLocale())}}", //ajax URL
    ajaxParams: function(){
...
$('#generate').click(function(e){
	...
	var filter_todate=$('#filter_todate').val();
	var filter_inv_type=$('#filter_inv_type').val();
	table.setData("{{route('inventory.reports.inventory_sales_per_item',app()->getLocale())}}", 
