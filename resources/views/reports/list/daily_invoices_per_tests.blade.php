...
var table = new Tabulator("#example-table", {
    ajaxURL:"{{route('reports.daily_invoices_per_tests',app()->getLocale())}}", //ajax URL
    ajaxParams: function(){
		...
		return {filter_test:filter_test,filter_patient:filter_patient,
    ...
    columns:[
		...
		{title:"{{__('Name')}}",field:"test_name"},
		{title:"{{__('Price')}}", field:"price",formatter:"money",formatterParams:{decimal:".",thousand:",",precision:0},bottomCalc:"sum",bottomCalcParams:{decimal:".",thousand:",",precision:0},bottomCalcFormatter:"money",bottomCalcFormatterParams:{decimal:".",thousand:",",precision:0}},
		{title:"{{__('Price$')}}", field:"priceUS",formatter:"money",formatterParams:{decimal:".",thousand:false,precision:2},bottomCalc:"sum",bottomCalcParams:{decimal:".",thousand:false,precision:2},bottomCalcFormatter:"money",bottomCalcFormatterParams:{decimal:".",thousand:false,precision:2}},
		...
		document.getElementById("download-pdf").addEventListener("click", function(){
			table.download("pdf", "invoices_per_tests.pdf", {
				orientation:"landscape", //set page orientation to portrait
				title:"{{__('Invoices per Tests')}}", //add title to report
			});
		});	
		...
		document.getElementById("download-csv").addEventListener("click", function(){
			table.download("csv", "invoices_per_tests.csv");
		});

		//trigger download of data.xlsx file
		document.getElementById("download-xlsx").addEventListener("click", function(){
			table.download("xlsx", "invoices_per_tests.xlsx", {sheetName:"{{__('Invoices per Tests')}}"});
		});
    ...
    $('#generate').click(function(e){
		e.preventDefault();
		 ...
		 var filter_todate=$('#filter_todate').val();
		 var filter_resource=$('#filter_resource').val();
		table.setData("{{route('reports.daily_invoices_per_tests',app()->getLocale())}}", 
					  {filter_test:filter_test,filter_patient:filter_patient,
		               filter_fromdate:filter_fromdate,filter_todate:filter_todate,
				       filter_resource:filter_resource});
