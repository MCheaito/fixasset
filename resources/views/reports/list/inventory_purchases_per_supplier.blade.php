 ...
 <div class="container-fluid bg-light">
   ...
   <div class="card">
      <div class="card-header report-menu">
	      <h5>{{__('Purchases per Supplier')}}</h5>
		 <div class="row m-1">
			 <div class="col-md-3">
...
$(document).ready(function(){
    ...
    ajaxURL:"{{route('inventory.reports.inventory_purchases_per_supplier',app()->getLocale())}}", //ajax URL
    ajaxParams: function(){
		...
		return {filter_supplier:filter_supplier, filter_item:filter_item,
...
$('#generate').click(function(e){
	...
	var filter_todate=$('#filter_todate').val();
	var filter_inv_type=$('#filter_inv_type').val();
	table.setData("{{route('inventory.reports.inventory_purchases_per_supplier',app()->getLocale())}}", 
	              {filter_supplier:filter_supplier, filter_item:filter_item,
		           filter_fromdate:filter_fromdate,filter_todate:filter_todate,filter_inv_type:filter_inv_type});
