    ...
    @endphp
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
					   ...
					   <li class="nav-item">
							<a class="nav-link {{ (request()->segment(2) == 'phlebotomy') ? 'active' : '' }}" href="{{ route('phlebotomy.index',app()->getLocale()) }}"><i class="text-sidebar fas fa-file-alt nav-icon"></i><p>{{ __('Phlebotomy') }}</p></a>
					   </li>
					   @endif
						@if( $access_patients_list) 	   
						<li class="nav-item">
								 <a class="nav-link {{ (request()->segment(3) == '' and request()->segment(2) == 'patientslist') ? 'active' : '' }}" href="{{ route('patientslist.index',app()->getLocale()) }}"><i class="text-sidebar far fa-address-card nav-icon"></i><p>{{ __('All Patients') }}</p></a>
						 </li>
				        @endif
						@if($access_inventory) 
						   <li class="nav-item {{ (request()->segment(2) == 'inventory') ? 'menu-open' : '' }}">
							...
							<a href="javascript:void(0)" class="nav-link {{ (request()->segment(2) == 'inventory' ) ? 'active' : '' }}">
							  ...
							  <p>{{__('Inventory')}}<i class="text-sidebar right fas fa-angle-left"></i></p>
							</a>
								 ...
								 @case(2)
									<ul class="ml-2 nav nav-treeview">
									  ...
									  <li class="nav-item">
									   ...
									   <li class="nav-item">
											  <a class="nav-link {{ (request()->segment(2) == 'inventory' ) && (request()->segment(3) == 'reports' ) ? 'active' : '' }}" href="{{ route('inventory.reports.index',app()->getLocale()) }}" onclick="localStorage.clear();"><i class="text-sidebar far fa-circle nav-icon"></i><p>{{ __('Inventory reports') }}</p></a>
										</li>
								   ...
								   @case(1)
									 <ul id="inventory_doctor" class="ml-2 nav nav-treeview">
										 ...
										 @else
											...
											<li class="nav-item">
											  <a class="nav-link" href="javascript:void(0)" onclick="localStorage.clear();Swal.fire({text:'{{__('Choose a branch')}}',icon:'error',customClass:'w-auto'});"><i class="text-sidebar far fa-circle nav-icon"></i><p>{{ __('Inventory reports') }}</p></a>
											</li>
					   ...
					   @if($access_visits)
					   	 @if(auth()->user()->type==2)
					      <li class="nav-item {{(request()->segment(3) == 'requests' and request()->segment(2) == 'lab') ? 'menu-open' : '' }}">
                                <a href="javascript:void(0)" class="nav-link {{ (request()->segment(3) == 'requests' and request()->segment(2) == 'lab') ? 'active' : '' }}">
									  <i class="nav-icon text-sidebar fas fa-clipboard-list"></i>
									  <p>Requests<i class="text-sidebar right fas fa-angle-left"></i></p>
								</a>
								<ul class="ml-2 nav nav-treeview">
								    <li class="nav-item">
							           <a class="nav-link {{ (request()->segment(4)===NULL && request()->segment(3) == 'requests' and request()->segment(2) == 'lab') ? 'active' : '' }}" href="{{ route('lab.visit.index',app()->getLocale()) }}"><i class="text-sidebar far fa-circle nav-icon"></i><p>{{ __('Lab') }}</p></a>
						           </li>
								   <li class="nav-item">
							          <a class="nav-link {{ (request()->segment(4) == 'in_process' and request()->segment(3) == 'requests' and request()->segment(2) == 'lab') ? 'active' : '' }}" href="{{ route('lab.visit.waiting_list',app()->getLocale()) }}"><i class="text-sidebar far fa-circle nav-icon"></i><p>{{ __('OUTREACH') }}</p></a>
						           </li>
							    </ul>
				           </li>
						  @else
						   <li class="nav-item">
							 <a class="nav-link {{ (request()->segment(3) == 'requests' and request()->segment(2) == 'lab') ? 'active' : '' }}" href="{{ route('lab.visit.index',app()->getLocale()) }}"><i class="text-sidebar fas fa-clipboard-list nav-icon"></i><p>{{ __('Requests') }}</p></a>
						   </li> 
                          @endif							  
				       @endif	
						
					   @if($access_billings)
					   	<li class="nav-item {{(request()->segment(3) == 'billing' and request()->segment(2) == 'lab') ||  (request()->segment(3) == 'ReferredLabs' and request()->segment(2) == 'lab') ? 'menu-open' : '' }}">
                                <a href="javascript:void(0)" class="nav-link {{ ((request()->segment(3) == 'billing' and request()->segment(2) == 'lab') ||  (request()->segment(3) == 'ReferredLabs' and request()->segment(2) == 'lab')) ? 'active' : '' }}">
									  <i class="nav-icon text-sidebar fas fa-file-invoice"></i>
									  <p>Invoices<i class="text-sidebar right fas fa-angle-left"></i></p>
								</a>
								<ul class="ml-2 nav nav-treeview">
								   <li class="nav-item">
							           <a class="nav-link {{ (request()->segment(3) == 'billing' and request()->segment(2) == 'lab') ? 'active' : '' }}" href="{{ route('lab.billing.index',app()->getLocale()) }}"><i class="text-sidebar far fa-circle nav-icon"></i><p>{{ __('Lab') }}</p></a>
						           </li>
								   <li class="nav-item">
									 <a class="nav-link {{ (request()->segment(3) == 'ReferredLabs' and request()->segment(2) == 'lab') ? 'active' : '' }}" href="{{ route('lab.referredlabs.index',app()->getLocale()) }}"><i class="text-sidebar far fa-circle nav-icon"></i><p>{{ __('Referred Labs') }}</p></a>
								   </li>
							    </ul>
				        </li>
				       @endif
					   ...
					   @if($access_general_reports || $access_custom_reports)
					   	<li class="nav-item {{(request()->segment(3) == 'reports' and request()->segment(2) == 'lab') ||  (request()->segment(3) == 'custom_reports' and request()->segment(2) == 'lab') ? 'menu-open' : '' }}">
                                <a href="javascript:void(0)" class="nav-link {{ ((request()->segment(3) == 'reports' and request()->segment(2) == 'lab') ||  (request()->segment(3) == 'custom_reports' and request()->segment(2) == 'lab')) ? 'active' : '' }}">
									  <i class="nav-icon text-sidebar fas fa-file-alt"></i>
									  <p>Reports<i class="text-sidebar right fas fa-angle-left"></i></p>
								</a>
								<ul class="ml-2 nav nav-treeview">
								  @if($access_general_reports)
						            <li class="nav-item">
							            <a class="nav-link {{ (request()->segment(3) == 'reports' and request()->segment(2) == 'lab') ? 'active' : '' }}"  href="{{ route('reports.index',app()->getLocale()) }}"><i class="text-sidebar far fa-circle nav-icon"></i><p>{{ __('General') }}</p></a>
						            </li>
				                  @endif
								  @if($access_custom_reports)
						            <li class="nav-item">
							            <a class="nav-link {{ (request()->segment(3) == 'custom_reports' and request()->segment(2) == 'lab') ? 'active' : '' }}"  href="{{ route('custom_reports.index',app()->getLocale()) }}"><i class="text-sidebar far fa-circle nav-icon"></i><p>{{ __('Template') }}</p></a>
						            </li>
				                  @endif
				                </ul>
				        </li>
				       @endif 	   
						...
						@if($access_tests_settings)
						  <li class="nav-item {{ (request()->segment(2) == 'tests' || request()->segment(2) == 'tests_fields' || request()->segment(2) == 'tests_groups' || request()->segment(2) == 'tests_categories' || request()->segment(2) == 'tests_profiles' || request()->segment(2) == 'tests_formulas' || request()->segment(2) == 'tests_bacteria' || request()->segment(2) == 'tests_antibiotic' ) ? 'menu-open' : '' }}">
