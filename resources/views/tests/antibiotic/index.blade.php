...
<div class="container-fluid">
   <div class="card card-outline">	  
	  <div class="card-header card-menu">
					...
					<div class="row">
						<div class="col-md-12">
						  <h3 class="text-dark">Lab Tests Antibiotic</h3>
					   </div> 
...
@include('tests.antibiotic.antLABModal')
@endsection
@section('scripts')
<script>
...
$(function(){
	...
	var table = $('#antibiotic_dt').DataTable({
        ...
        ajax: {
            url: "{{ route('lab.tests_antibiotic.index',app()->getLocale()) }}",
			data: function ( d ) {
	...
	$('#saveBtn').click(function (e) {
        ...
        $.ajax({
          ...
          url: "{{ route('lab.tests_antibiotic.store',app()->getLocale()) }}",
          type: "POST",
          dataType: 'json',
		  ...
		  customClass: 'w-auto'
			  ...
			  if (result.isConfirmed) {
				  $.ajax({
					...
					type: "DELETE",
					url: "{{ route('lab.tests_antibiotic.delete',app()->getLocale()) }}",
...
function editData(id) {
	  ...
	  $.ajax({
          data: {id:id},
          url: "{{ route('lab.tests_antibiotic.get_info',app()->getLocale()) }}",
		  type: "POST",
          dataType: 'json',
