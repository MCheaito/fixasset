...
-->
<div class="modal fade" id="newfieldModal" aria-hidden="true">
				 ...
				 @csrf
                  <div class="row">
					  ...
					  <div class="col-md-5 col-8">
						...
						<input type="text" id="test_name" name="test_name" class="form-control" readonly="true"/>
					  </div>
					  ...
					  <div class="form-group col-md-5">
						...
						<textarea id="descrip" class="rdata form-control" name="descrip" rows="3"></textarea>
					  </div>
					  <div class="form-group col-md-5">
					     <label for="name" class="label-size">{{__('Remark')}}</label>
						 <textarea id="remark" name="remark" class="rdata form-control" rows="3"></textarea>
					  </div>
					  ...
					  <div class="form-group mt-2 col-md-2">
						 <button  class="m-1 btn btn-action" id="saveFieldBtn">{{__("Save")}}</button>
