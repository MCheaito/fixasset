			        ...
			        <table id="dash_hist_table" class="table table-bordered table-striped   data-table nowrap" style="width:100%;">
									...
									<tbody>
									  ...
									  @foreach($history as $h)
									   <tr>
									     <td><a href="{{route('emr.visit.history.index',[app()->getLocale(),$h->id])}}" target="_blank" class="btn btn-action btn-sm">{{__('View')}}<span class="ml-1"><i class="fa fa-eye"></i></span></a></td>
										 <td>{{$h->id}}</td>
