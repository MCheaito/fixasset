					  ...
					  <div  style="border:2px solid padding:1px;">
                            ...
                            <div style="float:right;margin-right:5px;">
                                ...
                                @if(isset($patient->birthdate) && $patient->birthdate!='')
									 <div><b>{{__('Age').' : '}}</b> {{Carbon\Carbon::parse($patient->birthdate)->age.' '.__('year(s)')}}
								     <b style="margin-left: 20px;">{{__('Birth Date').' : '}}</b> {{Carbon\Carbon::parse($patient->birthdate)->format('d/m/Y')}}</div>
								@endif
