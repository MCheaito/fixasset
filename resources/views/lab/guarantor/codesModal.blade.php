             ...
             <div class="container-fluid p-0"> 
			  <div class="row"> 
			   <div class="col-md-6 mt-1 mb-2">
				  <label class="label-size">{{__('General Note')}}</label>
				  <textarea name="coll_notes" class="form-control"  id="coll_notes" rows="1" disabled></textarea>
			   </div>
			   <div class="col-cmd-3 mt-1 mb-2">
			      <input type="hidden" id="modal_order_id"/>
				  <button type="button"   class="btn btn-action" onclick="event.preventDefault();printRequestPDF()">{{__('Request')}}<i title="{{_('Print')}}" class="ml-1 far fa-file-pdf text-primary"></i></button>
