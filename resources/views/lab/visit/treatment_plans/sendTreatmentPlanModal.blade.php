...
-->
<!-- The Modal -->
<div class="modal hide fade in" id="sendTreatmentPlanModal"  tabindex="-1" data-keyboard="false" data-backdrop="false" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg movableDialog">
        <div class="modal-content">
            ...
            <div class="p-0 modal-body">
				  ...
				  <input type="hidden" id="code_type" value="treatment_plans"/>
