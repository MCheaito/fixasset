    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{__('Copy prices to Referred Lab')}}
				<span class="ml-3 badge badge-info">{{__('Note: The limited number of Referred Labs to copy prices is 10')}}</span>
				</h5>
                ...
                <form id="copypricesForm">
				  ...
				  <div class="row">
				      <div class="form-group col-md-4">
					    ...
					    <input type="text" disabled class="form-control" name="modal_ins_name" value="{{$pr->full_name}}"/>
					...
					<div class="row">
					  @foreach($other_ins as $o)
					    <div class="form-group col-md-4 col-6 checkbox-container">
						  <input type="checkbox" name="ins[]" class="ml-2 extINS"  value="{{$o->id}}"/><label class="label-size ml-2">{{$o->full_name}}</label>
						</div>
					  @endforeach
