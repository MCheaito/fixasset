                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register',app()->getLocale()) }}">
                        ...
                        <div class="row mb-3">
						  ...
						  <div class="row mb-3">
                            <label for="clinic_num" class="col-md-4 col-form-label text-md-end">{{ __('clinic_num') }}</label>

                            <div class="col-md-6">
                                <input id="clinic_num" type="text" class="form-control" name="clinic_num">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="admin_perm" class="col-md-4 col-form-label text-md-end">{{ __('Admin') }}</label>

                            <div class="col-md-6">
                             <select name="admin_perm" class="form-control" required>
							  <option value="O">{{__('Yes')}}</option>
