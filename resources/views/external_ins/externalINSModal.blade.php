...
-->
<div class="modal fade" id="externalINSModal" aria-hidden="true">
                ...
                <form id="extInsForm">
                  <div class="row">
					  ...
					  <div class="col-md-3">
						...
						<input type="text" class="form-control" name="alternative_phone1"/>
					  </div>
					  <div class="col-md-3">
					    <label for="name" class="label-size">{{__('Alternate Phone2')}}</label>
						<input type="text" class="form-control" name="alternative_phone2"/>
					  </div>
					  <!--<div class="col-md-3">
