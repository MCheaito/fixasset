        ...
        <section class="col-md-12">	
			<div class="card">	  
				...
				<div class="card-header">
				  <div class="row">
					  <div class="col-md-9 col-7"><h5>{{__('New Entry')}} - {{__($type1->name)}}</h5></div>
				...
				<div class="card-body p-0">
					...
					<div  class="row m-1">  
						  ...
						  <div  class="row m-1">
							 ...
							 <input type="text" class="form-control"  name="invoice_ref" id="invoice_ref" value="" />
							   ...
							   <div class="form-group col-md-2 select2-teal">
											...
											<select class="select2_data custom-select rounded-0" name="selectsource" id="selectsource" style="width:100%;" >
											<option value="0">{{__('Choose a source')}}</option>		
											@foreach($source as $ssource)
											<option value="{{$ssource->id}}">{{$ssource->name}}</option>
											@endforeach 
											</select>
						...
						<div  class="row m-1"> 
							 ...
							 <div class="form-group col-md-3 select2-teal">
									...
									<input  class="form-control" value="" id="fvalrate" name="fvalrate"/>
									</div>	
									</div>							 
									<div class="col-md-2 col-3">
									<div class="d-flex flex-column">
									<label for="name"><b>{{__('Amount')}}</b></label>
									<input  class="form-control" value="" id="fvalamount" name="fvalamount"/>
									</div>
									</div>
					...
					<div class="form-group col-md-3 select2-teal">
										<label for="pro"><b>{{__('To ').'*'}}</b></label>
											<select class="select2_data custom-select rounded-0" name="tselectpro" id="tselectpro" style="width:100%;" >
											<option value="0">{{__('Choose a supplier')}}</option>		
											@foreach($fournisseur as $fournisseurs)
											<option value="{{$fournisseurs->id}}">{{$fournisseurs->name}}</option>
											@endforeach 
							 ...
							 <div class="form-group col-md-3 select2-teal">
												<label for="pro"><b>{{__('Currency')}}</b></label>
													<select class="select2_data custom-select rounded-0" name="tcurrency" id="tcurrency" style="width:100%;" >
													<option value="LBP">{{__('LBP')}}</option>		
													<option value="USD">{{__('USD')}}</option>
													<option value="EUR">{{__('EUR')}}</option>
													</select>
									...
									<div class="d-flex flex-column">
									<label for="name"><b>{{__('Rate')}}</b></label>
									<input  class="form-control" value="" id="tvalrate" name="tvalrate"/>
									</div>	
									</div>							 
									<div class="col-md-2 col-3">
									<div class="d-flex flex-column">
									<label for="name"><b>{{__('Amount')}}</b></label>
									<input  class="form-control" value="" id="tvalamount" name="tvalamount"/>
									</div>
									</div>
				...
				<div class="card-body">
						...
						<div class="col-md-6">
							...
							<div class="row">
								<div class="col-md-4">
									...
									<input class="text-center form-control" id="lstotal1" disabled />
								</div>
								<div class="col-md-4">
									<label for="name">{{__('Total EUR')}}</label>
									<input class="text-center form-control" id="estotal1" disabled />
								</div>
								<div class="col-md-4">
									<label for="name">{{__('Total USD')}}</label>
									<input class="text-center form-control" id="ustotal1" disabled />
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							...
							<div class="row">
								<div class="col-md-4">
									<label for="name">{{__('Total LBP')}}</label>
									<input class="text-center form-control" id="lstotal2" disabled />
								</div>
								<div class="col-md-4">
									<label for="name">{{__('Total EUR')}}</label>
									<input class="text-center form-control" id="estotal2" disabled />
								</div>
								<div class="col-md-4">
									<label for="name">{{__('Total USD')}}</label>
									<input class="text-center form-control" id="ustotal2" disabled />
								</div>
							</div>
						</div>
					</div>
