...
if ($lang=='fr'){			 
	...
	$payeuro=number_format((float)$payeuro,2,'.',',');
	   return view('lab.extlabs.index')->with(['methodepay'=>$methodepay,'currencys'=>$currencys,'tdollar'=>$tdollar,'teuro'=>$teuro,'paydollar'=>$paydollar,'payeuro'=>$payeuro,'FromFacility'=>$clinics,'ext_labs'=>$ext_labs,'doctors'=>$doctors,
